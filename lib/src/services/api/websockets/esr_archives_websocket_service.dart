...
class ESRArchivesListensCounterWebsocketService {
  final sdk = ESRSDK();
  String _baseWebSocketURL = "";
  ESRLang? _language;
  int _pageSize = 1;
  ...
  bool _isConnected = false;
  WebSocketChannel? _channel;
  final StreamController<ESRArchivesListensCounterByArchiveResults> _controller =
  StreamController<ESRArchivesListensCounterByArchiveResults>.broadcast();

  ESRArchivesListensCounterWebsocketService() {
    if (sdk.env == ESREnvironments.test) {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketTestUrl}/archive-history-listens-by-archive/";
    } else {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketUrl}/archive-history-listens-by-archive/";
    }
  }
  ...
  void connect() {
    ...
    _channel?.stream.listen(
          (message) {
        Map<String, dynamic> jsonMessage = jsonDecode(message);
        _controller.add(ESRArchivesListensCounterByArchiveResults.fromJson(jsonMessage));
      },
      onError: (error) {
        _isConnected = false;
        disconnect();
  ...
  Stream<ESRArchivesListensCounterByArchiveResults> get stream => _controller.stream;

  StreamSubscription<ESRArchivesListensCounterByArchiveResults> addListener(
      void Function(ESRArchivesListensCounterByArchiveResults event) onData,
      {Function? onError,
        void Function()? onDone,
        bool? cancelOnError}) {
    return _controller.stream.listen(
...
class ESRArchivesLikesCounterWebsocketService {
  final sdk = ESRSDK();
  String _baseWebSocketURL = "";
  ESRLang? _language;
  int _pageSize = 1;
  ...
  bool _isConnected = false;
  WebSocketChannel? _channel;
  final StreamController<ESRArchivesLikesCounterByArchiveResults> _controller =
  StreamController<ESRArchivesLikesCounterByArchiveResults>.broadcast();

  ESRArchivesLikesCounterWebsocketService() {
    if (sdk.env == ESREnvironments.test) {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketTestUrl}/like-archives-by-archive/";
    } else {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketUrl}/like-archives-by-archive/";
    }
  }
  ...
  void connect() {
    ...
    _channel?.stream.listen(
          (message) {
        Map<String, dynamic> jsonMessage = jsonDecode(message);
        _controller.add(ESRArchivesLikesCounterByArchiveResults.fromJson(jsonMessage));
      },
      onError: (error) {
        _isConnected = false;
        disconnect();
  ...
  Stream<ESRArchivesLikesCounterByArchiveResults> get stream => _controller.stream;

  StreamSubscription<ESRArchivesLikesCounterByArchiveResults> addListener(
      void Function(ESRArchivesLikesCounterByArchiveResults event) onData,
      {Function? onError,
        void Function()? onDone,
        bool? cancelOnError}) {
    return _controller.stream.listen(
...
class ESRArchivesAverageRatingsWebsocketService {
  final sdk = ESRSDK();
  String _baseWebSocketURL = "";
  ESRLang? _language;
  int _pageSize = 1;
  ...
  bool _isConnected = false;
  WebSocketChannel? _channel;
  final StreamController<ESRArchivesAverageRatingByArchiveResults> _controller =
  StreamController<ESRArchivesAverageRatingByArchiveResults>.broadcast();

  ESRArchivesAverageRatingsWebsocketService() {
    if (sdk.env == ESREnvironments.test) {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketTestUrl}/archive-average-rating-by-archive/";
    } else {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketUrl}/archive-average-rating-by-archive/";
    }
  }
  ...
  void connect() {
    ...
    _channel?.stream.listen(
          (message) {
        Map<String, dynamic> jsonMessage = jsonDecode(message);
        _controller.add(ESRArchivesAverageRatingByArchiveResults.fromJson(jsonMessage));
      },
      onError: (error) {
        _isConnected = false;
        disconnect();
  ...
  Stream<ESRArchivesAverageRatingByArchiveResults> get stream => _controller.stream;

  StreamSubscription<ESRArchivesAverageRatingByArchiveResults> addListener(
      void Function(ESRArchivesAverageRatingByArchiveResults event) onData,
      {Function? onError,
        void Function()? onDone,
        bool? cancelOnError}) {
    return _controller.stream.listen(
...
class ESRArchivesBySchoolWebsocketService {
  final sdk = ESRSDK();
  String _baseWebSocketURL = "";
  ESRLang? _language;
  int _pageSize = 1;
  ...
  ESRArchivesBySchoolWebsocketService() {
    if (sdk.env == ESREnvironments.test) {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketTestUrl}/archives-by-school/";
    } else {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketUrl}/archives-by-school/";
    }
  }
...
class ESRArchivesByUserWebsocketService {
  final sdk = ESRSDK();
  String _baseWebSocketURL = "";
  ESRLang? _language;
  int _pageSize = 1;
  ...
  ESRArchivesByUserWebsocketService() {
    if (sdk.env == ESREnvironments.test) {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketTestUrl}/archives-by-user/";
    } else {
      _baseWebSocketURL =
      "${ESRServerConfig.websocketUrl}/archives-by-user/";
    }
  }
